        ...
        <div class="mx-auto flex min-h-screen w-full max-w-md items-center px-4 py-10 sm:px-6">
            <div class="w-full rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8">
                <div class="mb-8 text-center">
                    ...
                    <h1 class="text-3xl font-black tracking-tight text-white sm:text-4xl">Register</h1>
                    <p class="mt-2 text-sm text-slate-300">Set up your account and get started in a minute.</p>
                </div>
                ...
                <p class="mt-6 text-center text-sm text-slate-300">
                    ...
                    <a href="{{ route('login') }}" class="font-semibold text-cyan-300 transition hover:text-cyan-200 hover:underline">
                        Sign in
                    </a>
                </p>
            </div>
